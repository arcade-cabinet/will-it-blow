const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/SurrealText-Bgy8S3lF.js","assets/react-three-fiber.esm-BXLo3r32.js"])))=>i.map(i=>d[i]);
...
const _Users_jbogaty_src_arcade_cabinet_will_it_blow_src_components_camera___tests____react_three_fiber_Canvas = () => __vitePreload(() => import('./react-three-fiber.esm-BXLo3r32.js').then(n => n.cN),true              ?[]:void 0).then((mod) => mod.Canvas);
const _Users_jbogaty_src_arcade_cabinet_will_it_blow_src_components_environment_SurrealText_SurrealText = () => __vitePreload(() => import('./SurrealText-Bgy8S3lF.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.SurrealText);
__pwRegistry.initialize({ _Users_jbogaty_src_arcade_cabinet_will_it_blow_src_components_camera___tests____react_three_fiber_Canvas,
  _Users_jbogaty_src_arcade_cabinet_will_it_blow_src_components_environment_SurrealText_SurrealText });

export { React as R, __vitePreload as _, requireReact as a, requireScheduler as b, clientExports as c, getDefaultExportFromCjs as g, reactExports as r };
//# sourceMappingURL=index-CMBHrXXw.js.map
