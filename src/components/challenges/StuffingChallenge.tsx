...
export function StuffingChallenge({ onComplete, onReaction }: StuffingChallengeProps) {
	...
	}, [phase, variant, addStrike, setChallengeProgress, setChallengePressure, onComplete, onReaction]);
