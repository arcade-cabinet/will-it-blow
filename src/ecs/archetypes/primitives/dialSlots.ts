...
/**
 * Create slot definitions for a segmented rotary dial.
 *
 * Returns 1 slot (body only) or 2 slots (body + notch indicator)
 * depending on whether `config.notch` is provided.
 */
export function dialSlots(config: DialConfig): SlotDefinition[] {
